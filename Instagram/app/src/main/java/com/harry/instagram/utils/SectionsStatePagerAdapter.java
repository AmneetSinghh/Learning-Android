...
public class SectionsStatePagerAdapter extends FragmentStatePagerAdapter {
    ...
    {
        if(mFragmentNumbers.containsKey(fragmentName))return mFragmentNumbers.get(fragmentName);
        else return null;
    }

    public Integer getFragmentNumber(Fragment fragment)
    {
        if(mFragments.containsKey(fragment))return mFragments.get(fragment);
        else return null;
    }
